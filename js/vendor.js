...
Line 423:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 436:4 Transforming let to the configured target environment ("es5") is not supported yet
Line 437:4 Transforming const to the configured target environment ("es5") is not supported yet
Line 438:4 Transforming const to the configured target environment ("es5") is not supported yet
Line 442:16 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 443:16 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 444:14 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 452:6 Transforming const to the configured target environment ("es5") is not supported yet
Line 453:6 Transforming const to the configured target environment ("es5") is not supported yet
Line 457:6 Transforming const to the configured target environment ("es5") is not supported yet
... and 359 more hidden warnings
